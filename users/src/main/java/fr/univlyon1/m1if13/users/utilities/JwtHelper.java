...
public class JwtHelper {
    ...
    private static final String ISSUER = "JeuUCBL";
    ...
    private static final JWTVerifier connectedVerifier = JWT.require(algorithm).withClaim("connected", true).build(); // Reusable verifier instance
     ...
     */
    public static String verifyToken(String token, @NotNull String req) throws NullPointerException, JWTVerificationException {
     ...
     */
    public static boolean verifyConnected(String token) {
        try {
            connectedVerifier.verify(token);
            return true;
     ...
     * @param connected le statut de connexion de l'utilisateur
     ...
     */
    public static String generateToken(String subject, String password, boolean connected, String req) throws JWTCreationException {
        return JWT.create()
                .withIssuer(ISSUER)
                .withSubject(subject)
                .withAudience(req)
